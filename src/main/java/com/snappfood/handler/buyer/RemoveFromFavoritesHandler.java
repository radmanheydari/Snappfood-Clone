...
public class RemoveFromFavoritesHandler implements HttpHandler {
    ...
    public RemoveFromFavoritesHandler(long restaurantId) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        int status = 200;
        Object body = Map.of("message", "Removed from favorites");
        ...
        try {
            ...
            userRepo.removeRestaurantFromFavorites(userId, restaurantId);
